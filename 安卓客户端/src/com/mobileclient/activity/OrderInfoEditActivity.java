...
public class OrderInfoEditActivity extends Activity {
			...
			public void onClick(View v) {
				try {
					...
					if(ET_moviePrice.getText().toString().equals("")) {
						Toast.makeText(OrderInfoEditActivity.this, "电影价格输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_orderNum.getText().toString().equals("")) {
						Toast.makeText(OrderInfoEditActivity.this, "购买数量输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_orderPrice.getText().toString().equals("")) {
						Toast.makeText(OrderInfoEditActivity.this, "订单总价输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_receiveName.getText().toString().equals("")) {
						Toast.makeText(OrderInfoEditActivity.this, "收货人输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_address.getText().toString().equals("")) {
						Toast.makeText(OrderInfoEditActivity.this, "收货人地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_orderMemo.getText().toString().equals("")) {
						Toast.makeText(OrderInfoEditActivity.this, "订单备注输入不能为空!", Toast.LENGTH_LONG).show();
	...
	private void initViewData() {
		...
		for (int i = 0; i < movieList.size(); i++) {
			if (orderInfo.getMovieObj() == movieList.get(i).getMovieId()) {
				this.spinner_movieObj.setSelection(i);
				break;
			}
		}
		this.ET_moviePrice.setText(orderInfo.getMoviePrice() + "");
		this.ET_orderNum.setText(orderInfo.getOrderNum() + "");
		this.ET_orderPrice.setText(orderInfo.getOrderPrice() + "");
		...
		this.ET_receiveName.setText(orderInfo.getReceiveName());
		...
		for (int i = 0; i < orderStateList.size(); i++) {
			if (orderInfo.getOrderStateObj() == orderStateList.get(i).getOrderStateId()) {
